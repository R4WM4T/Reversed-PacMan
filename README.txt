Ce mini-jeu que j'ai réalisé au début du confinement est avant tout centré sur le Java Script.
...
A chaque période donnée, le fantome, si il n'a pas reçu de changement de trajectoire, répète le même mouvement que le 
précédent. 
